...
public class Customer {
    ...
    public String toString() {
        ...
        return "|Customer ID= " +customerID +" |Company Name= " +companyName +" |Contact Name= " +contactName +" |Contact Title= " 
        +contactTitle +" |Address= " +address +" |City= " +city +" |Region= " +region +" |Country= " +country
        +" |Postal Code= " +postalCode + " |Phone= " +phone +" |Fax= " +fax; 
    }
